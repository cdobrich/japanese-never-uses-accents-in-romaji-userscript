Userscript script (Greasemonkey, Tampermonkey, ViolentMonkey, ScriptCat) to correct the display of Japanese language in English characters.
...
This would be like asking Google Translate to translate Spanish into English, and the website randomly puts cyrillic (Б,Ж,Ф,Э,Ю) into the middle of the english-letters.
...
- Japanese DOES NOT use accent marks for their words.
  ...
  - THERE IS NO ENGLISH OR JAPANESE SPEAKERS WHICH BENEFIT FROM USING ACCENT MARKS to wrongly translate Japanese into English.
- If you travel in Japan you will not find signs with accents. You will find them with proper simple English letter usage.
